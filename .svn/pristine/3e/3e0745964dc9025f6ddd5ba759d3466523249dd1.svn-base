...
#' Compute the area under the ROC curve according to the model-based densities
#'
#' @param densities Adjusted densities computed by
#'        \code{\link{Wdensities.fromraw}}.
#' @return The model-based AUROC.
#'
...
#' @return The proportion of controls and cases with weight of evidence below
#'         the given threshold.
#'
#' @export
...
#' @param densities Adjusted densities computed by
#'        \code{\link{Wdensities.fromraw}}.
#' @return The mean densities in controls and in cases.
#'
#' @export
